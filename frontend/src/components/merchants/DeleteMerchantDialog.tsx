      ...
      <div className="bg-graphite-900 border border-graphite-800 rounded-xl max-w-md w-full p-6 space-y-4 shadow-2xl animate-in fade-in zoom-in duration-200">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="text-base font-bold text-white">Delete Merchant</h3>
              <p className="text-xs text-graphite-400">Soft delete record from active index</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <p className="text-sm text-graphite-300">
          Are you sure you want to soft-delete merchant{" "}
